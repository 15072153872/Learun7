...
namespace Learun.Application.Base.CodeGeneratorModule
{
    ...
    public class CodeGenerator
    {
        ...
        private string NotesCreate(CodeBaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 Learun-ADMS-Ultimate V7.0.0 力软敏捷开发框架 \r\n");
        ...
        public string ReportServiceCreate(string databaseLinkId, string strSql, List<ReportColModel> collist, QueryModel queryData, BaseModel baseInfo)
        {
            try
            {
                ...
                content += "                var strSql = new StringBuilder();\r\n";
                content += "                strSql.Append(\"SELECT  \");\r\n";
                content += "                strSql.Append(@\"" + querySqlField + " \");\r\n";
        ...
        public string IndexCreate(BaseModel baseInfo, Dictionary<string, CodeFormCompontModel> compontMap, QueryModel queryData, ColModel colData)
        {
            try
            {
                ...
                if (colData.isTree == "1")
                {
                    sb.Append("    <div class=\"lr-layout-left\">\r\n");
                    sb.Append("        <div class=\"lr-layout-wrap\">\r\n");
                    sb.Append("            <div class=\"lr-layout-title lrlt \">树形列表</div>\r\n");
                ...
                if (colData.isTree == "1")
                {
                    ...
                    sb.Append("                <span id=\"titleinfo\" class=\"lrlt\">列表信息</span>\r\n");
                    sb.Append("            </div>\r\n");
                }
        ...
        public string IndexJSCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("/*");
                sb.Append(" * 版 本 Learun-ADMS-Ultimate V7.0.0 力软敏捷开发框架(http://www.learun.cn) \r\n");
                sb.Append(" * Copyright (c) 2013-2018 上海力软信息技术有限公司 \r\n");
        ...
        public string AreaRegistrationCreate(BaseModel baseModel)
        {
            StringBuilder sb = new StringBuilder();


            sb.AppendLine($"using System.Web.Mvc;");
            sb.AppendLine($"namespace Learun.Application.Web.Areas.{baseModel.outputArea}");
            sb.AppendLine("{");
            sb.AppendLine($"    public class {baseModel.outputArea}AreaRegistration : AreaRegistration");
            sb.AppendLine("    {");
            sb.AppendLine($"        public override string AreaName");
            sb.AppendLine("        {");
            sb.AppendLine($"            get");
            sb.AppendLine("            {");
            sb.AppendLine($"                return \"{baseModel.outputArea}\"; ");
            sb.AppendLine("            }");
            sb.AppendLine("        }");
            sb.AppendLine($"        public override void RegisterArea(AreaRegistrationContext context) ");
            sb.AppendLine("        {");
            sb.AppendLine($"            context.MapRoute(");
            sb.AppendLine($"                \"{baseModel.outputArea}_default\", ");
            sb.AppendLine("                \"" + baseModel.outputArea + "/{controller}/{action}/{id}\", ");
            sb.AppendLine("                             new { action = \"Index\", id = UrlParameter.Optional }");
            sb.AppendLine($"            );");
            sb.AppendLine("        }");
            sb.AppendLine("    }");
            sb.AppendLine("}");
