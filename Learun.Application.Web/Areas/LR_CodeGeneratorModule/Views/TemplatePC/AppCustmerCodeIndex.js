...
var bootstrap = function ($, learun) {
    ...
    var page = {
            ...
            $('#wizard').wizard().on('change', function (e, data) {
                ...
                if (data.direction == "next") {
                    if (data.step == 1) {
                        ...
                        learun.httpAsyncPost(top.$.rootUrl + '/LR_CodeGeneratorModule/TemplatePC/LookAppCustmerCode', postData, function (res) {
                            if (res.code == 200) {
            ...
            $('#appselectIcon').on('click', function () {
                learun.layerForm({
                    ...
                    maxmin: true,
                        ...
                        if (top._learunSelectIcon != '') {
                            $('#F_appIcon').val(top._learunSelectIcon);
                        }
                    }
                });
            });
        ...
        save: function () {
            ...
            $.lrSaveForm(top.$.rootUrl + '/LR_CodeGeneratorModule/TemplatePC/CreateAppCustmerCode', postData, function (res) { }, true);
        }
    };
