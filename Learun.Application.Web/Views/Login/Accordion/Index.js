...
(function ($) {
    ...
    var lrPage = {
        init: function () {
            $('.lr-login-body').css('background', 'url(' + $.rootUrl + '/Content/images/Login/bgmask1.png) no-repeat left top, url(' + $.rootUrl + '/Content/images/Login/bgmask2.png) no-repeat right bottom, url(' + $.rootUrl + '/Content/images/Login/bgmask3.png) no-repeat right top');
            $('#psw_change').css({
