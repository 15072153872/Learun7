    ...
    var c = {
        ...
        bind: function () {
            function d() {
                ...
                var g = window.URL.createObjectURL(e);
                document.getElementById("uploadPreview").src = g
            }
            a("#uploadFile").on("change", d);
        ...
        initData: function () {
            a(".file").prepend('<img id="uploadPreview"  src="' + top.$.rootUrl + '/LR_SystemModule/LogoImg/GetImg?code=applogo" >')
        }
    };
    c.init()
};